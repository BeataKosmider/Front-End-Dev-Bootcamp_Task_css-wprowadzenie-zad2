...
```
cd existing_repo
git remote add origin https://gitlab.portal.futurecollars.com/beata_kosmider/css-wprowadzenie-zad2.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.portal.futurecollars.com/beata_kosmider/css-wprowadzenie-zad2/-/settings/integrations)
